---
title: MIA Toolkit v0.1.0 → v0.1.5
slug: release-notes-v0-1-5
date: 2026-06-05
summary: From rip-your-CDs to six languages, USB/ZIP import, and a notarized Mac app — everything six releases have added, still as free as day one.
languages: [en]
status: published
...
- **Insert a disc** — the classic auto-loop, unchanged.
- **From a folder or USB** — point at the drive the hospital gave you.
- **From a ZIP file** — the download from your patient portal, even when it's zips-inside-zips.
